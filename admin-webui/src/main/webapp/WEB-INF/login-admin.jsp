...
<div class="container">
    ...
    <form class="form-signin" role="form" action="security/admin/do/login" method="post">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" name="userPwd" id="inputSuccess4" placeholder="请输入登录密码" style="margin-top:10px;">
